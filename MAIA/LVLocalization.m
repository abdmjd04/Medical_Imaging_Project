...
img = dcmread('Z:\Images\NeoStem AMR\AMR-002_132019 - Sorted\001-002\Screening - 1.2.840.113970.3.57.1.25749326.20120119.1140621\DCM9021_TRUFI_CINE_SA_stack');
test = zeros(size(img));
for i = 1:size(img,3)
    test(:,:,i) = kmeans2(img(:,:,i),2);
end